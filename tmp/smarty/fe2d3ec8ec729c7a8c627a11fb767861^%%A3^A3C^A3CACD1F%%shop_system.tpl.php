<?php /* Smarty version 2.6.26, created on 2014-05-11 21:44:42
...
>
            ...
            <dl>
                <dt>
                    <textarea class="txtfield" name=confarrs[aDeniedDynGroups] <?php echo $this->_tpl_vars['readonly']; ?>
><?php echo $this->_tpl_vars['confarrs']['aDeniedDynGroups']; ?>
</textarea>
                    <?php echo smarty_function_oxinputhelp(array('ident' => 'HELP_SHOP_SYSTEM_DENIEDDYNGROUPS'), $this);?>

                </dt>
                <dd>
                    <?php echo smarty_function_oxmultilang(array('ident' => 'SHOP_SYSTEM_DENIEDDYNGROUPS'), $this);?>
