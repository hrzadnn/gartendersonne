 ...
 */
    ...
    /** @name database information */
        $this->dbHost = 'db379305446.db.1and1.com'; // database host name
        $this->dbName = 'db379305446'; // database name
        $this->dbUser = 'dbo379305446'; // database user name
        $this->dbPwd = 'cls16820'; // database user password
        $this->dbType = 'mysql';
        $this->sShopURL = 'http://gartendersonne.projectprototypes.de'; // eShop base url, required
        $this->sSSLShopURL  = null;            // eShop SSL url, optional
        $this->sAdminSSLURL = null;            // eShop Admin SSL url, optional
        $this->sShopDir = '/kunden/homepages/5/d379013128/htdocs/gartendersonne';
        $this->sCompileDir = '/kunden/homepages/5/d379013128/htdocs/gartendersonne/tmp';
